# Audacity transient_burst_reassignment_2s Capture Log
...
- SHA256: `CF9785D28506759AA1AAA0AAA43BE8CD1CCC4AD59C38DC2DD07DB9EC310610C9`

## Observations

- Imported track metadata is recorded in `capture-session.log`.
- The capture shows repeated short vertical burst columns at regular half-second spacing rather than continuous horizontal tonal bands.
- Within each burst, brighter localized energy appears around several fixed frequency zones, including a mid band near `700` Hz and higher bands above `1.5 kHz`.
